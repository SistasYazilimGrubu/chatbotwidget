...
Bu komutlar, ``/chatbot-gateway/src/main/webapp/widget/`` klasörüne `widget.html` ve `widget.js` dosyalarını kopyalar.

``widget.html`` widget test sayfası, `widget.js` ise widget componentinin javascript kodlarının içerir.
