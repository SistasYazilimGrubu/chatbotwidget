  ...
  return function reducer(state = initialState, action) {
    ...
    switch (action.type) {
      ...
      case actionTypes.ADD_NEW_USER_MESSAGE: {
        return storeMessage(state.push(createNewMessage(action.message, MESSAGE_SENDER.CLIENT)));
      }
      case actionTypes.ADD_NEW_RESPONSE_MESSAGE: {
        return storeMessage(state.push(createNewMessage(action.message, MESSAGE_SENDER.RESPONSE)));
      }
      ...
      case actionTypes.ADD_NEW_CUSTOM_CUSTOMREPLY: {
        return storeMessage(state.push(createCustomSnippet(action.custom, MESSAGE_SENDER.RESPONSE)));
      }
